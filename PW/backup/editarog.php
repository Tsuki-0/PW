...
<head>
    ...
    <title>Editar Enfermeiro — EnfermaGest</title>
    <link rel="icon" type="image/icon" href="img/icon.png">
    <link rel="stylesheet" href="css/bootstrap.min.css">
    <link rel="stylesheet" href="css/estilo.css">
    <style>
        /* ── exclusivo: input file estilizado ── */
        .file-drop {
    ...
    <div class="form-wrap">
        <form action="editar.php?id=<?= $idEnc ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="date" name="datanasc" class="form-control-custom"
                    value="<?= $datanasc ?>">
            </div>
            ...
            <div class="form-group">
                <label class="form-label foto">Foto atual</label>
                <img src="img/<?= $foto ?>" id="preview" class="foto" alt="foto atual">
            </div>
